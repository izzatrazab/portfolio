...
export let db = {
    biodata: {
        ...
        education:
            "Bachelor of Computer Science (Software Engineering)  University of Malaya (cgpa: 3.65). I already finished all semesters and expected to officially graduate end of this year.",
    },
    kakitangan: {
